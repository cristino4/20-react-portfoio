            ...
            <div className="hero bg-white dark:bg-zinc-900">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        ...
                        <p className="font-sans py-6">I'm an electrical engineer and software developer from 
                        Anaheim, California. <br></br><br></br>
                        ...
                        You may download my resume <a href='#Resume' onClick = {() => handlePageChange('Resume')} className='underline text-blue-600 hover:text-blue-800 visited:text-purple-600'>here</a> or look at my software development portfolio <a href='#Portfolio' onClick = {() => handlePageChange('Portfolio')} className='underline text-blue-600 hover:text-blue-800 visited:text-purple-600'>here</a> for more info.
                        <br></br><br></br>
                        Gracias!
                        </p>
                    </div>
